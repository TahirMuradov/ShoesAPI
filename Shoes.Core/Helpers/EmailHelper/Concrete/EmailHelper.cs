...
namespace Shoes.Core.Helpers.EmailHelper.Concrete
{
    public class EmailHelper : IEmailHelper
    {
        ...
        public async Task<IResult> SendEmailAsync(string userEmail, string confirmationLink, string UserName)
        {
            ...
            try
            {
                ...
                email.Subject = "Elektron Poçt Təsdiqləmə";
                //string filePath = Path.Combine("C:\\Users\\MSI\\source\\repos\\Karl_Fashion_Architecture_N-Tier\\WebUI\\wwwroot\\uploads\\OrderPDFs\\a2515e.pdf");
                ...
                //multipart.Add(new TextPart(TextFormat.Html) { Text = htmlBody2 });

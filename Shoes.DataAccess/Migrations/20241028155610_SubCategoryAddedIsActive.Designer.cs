...
namespace Shoes.DataAccess.Migrations
{
    ...
    [Migration("20241028155610_SubCategoryAddedIsActive")]
    partial class SubCategoryAddedIsActive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shoes.Entites.CategoryCupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shoes.Entites.ProductCupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shoes.Entites.SubCategoryCupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shoes.Entites.UserCupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shoes.Entites.User", b =>
                {
                    b.HasBaseType("Shoes.Core.Entities.Concrete.AppUser");
            ...
            modelBuilder.Entity("Shoes.Entites.CategoryCupon", b =>
                {
                    b.HasOne("Shoes.Entites.Category", "Category")
                        .WithMany("CategoryCupons")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shoes.Entites.Cupon", "Cupon")
                        .WithMany("CategoryCupons")
            ...
            modelBuilder.Entity("Shoes.Entites.Cupon", b =>
                {
                    ...
                    b.Navigation("ProductCupons");

                    b.Navigation("SubCategoryCupons");
